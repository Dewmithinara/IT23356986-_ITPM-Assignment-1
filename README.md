...
- IT23356986.py                → Playwright automation script  
- Assignment_1_-_Test_cases_Complete (1).xlsx  → Excel file with test cases & results  
- IT23356986 - Requirement .txt     → Python dependencies  
- IT23356986 _README.md             → Project documentation  
